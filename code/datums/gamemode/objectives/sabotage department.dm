/datum/objective/sabotage_command
	...
	explanation_text = "Sabotage command in any way you see fit"
...
/datum/objective/sabotage_security
	var/datum/mind/owner = TRUE
	explanation_text = "Sabotage the security department in any way you see fit"
	var/force_success = FALSE
...
/datum/objective/sabotage_security/IsFulfilled()
	...
	var/datum/mind/owner = TRUE
	explanation_text = "Sabotage the engineering department in any way you see fit"
	var/force_success = FALSE
...
/datum/objective/sabotage_engineering/IsFulfilled()
	...
	var/datum/mind/owner = TRUE
	explanation_text = "Sabotage the cargo department in any way you see fit"
	var/force_success = FALSE
	name = "sabotage cargo"
...
/datum/objective/sabotage_cargo/IsFulfilled()
	...
	var/datum/mind/owner = TRUE
	explanation_text = "Sabotage the medical department in any way you see fit"
	var/force_success = FALSE
...
/datum/objective/sabotage_medical/IsFulfilled()
	...
	var/datum/mind/owner = TRUE
	explanation_text = "Sabotage the science department in any way you see fit"
	var/force_success = FALSE
...
/datum/objective/sabotage_science/IsFulfilled()
	...
	var/datum/mind/owner = TRUE
	explanation_text = "Sabotage the service and civilian departments in any way you see fit"
	var/force_success = FALSE
